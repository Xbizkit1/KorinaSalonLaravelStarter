...
class DatabaseSeeder extends Seeder { public function run(): void {
  ...
  $staff=User::factory()->create(['name'=>'Mika Santos','email'=>'mika@korina.test','role'=>'staff','specialty'=>'Hair Color & Keratin']);
  User::factory()->create(['name'=>'Aira Dela Cruz','email'=>'aira@korina.test','role'=>'staff','specialty'=>'Nail Art & Manicures']);
  User::factory()->create(['name'=>'Lina Garcia','email'=>'lina@korina.test','role'=>'assistant','specialty'=>'Shampoo, Blow-Dry & Client Care']);
